...
output "outpost_subnet_ids" {
  ...
  value       = module.vpc.outpost_subnet_ids
}
...
output "outpost_subnet_cidr_blocks" {
  ...
  value       = module.vpc.outpost_subnet_cidr_blocks
}

output "outpost_subnet_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of outpost subnets in an IPv6 enabled VPC"
  value       = module.vpc.outpost_subnet_ipv6_cidr_blocks
}
...
output "database_subnet_ipv6_cidr_blocks" {
  ...
  value       = module.vpc.database_subnet_ipv6_cidr_blocks
}
...
output "redshift_subnet_ids" {
  ...
  value       = module.vpc.redshift_subnet_ids
}
...
output "redshift_subnet_cidr_blocks" {
  ...
  value       = module.vpc.redshift_subnet_cidr_blocks
}

output "redshift_subnet_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of redshift subnets in an IPv6 enabled VPC"
  value       = module.vpc.redshift_subnet_ipv6_cidr_blocks
}
...
output "elasticache_subnet_cidr_blocks" {
  ...
  value       = module.vpc.elasticache_subnet_cidr_blocks
}

output "elasticache_subnet_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of elasticache subnets in an IPv6 enabled VPC"
  value       = module.vpc.elasticache_subnet_ipv6_cidr_blocks
}

output "elasticache_subnet_group_id" {
  description = "ID of elasticache subnet group"
  value       = module.vpc.elasticache_subnet_group_id
}
...
output "intra_subnet_ipv6_cidr_blocks" {
  ...
  value       = module.vpc.intra_subnet_ipv6_cidr_blocks
}
...
output "nat_gateway_interface_ids" {
  ...
  value       = module.vpc.nat_gateway_interface_ids
}
...
output "vpn_gateway_arn" {
  ...
  value       = module.vpc.vpn_gateway_arn
}
